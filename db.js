...
const DB = {
  ...
  async login(username, password) {
    ...
    const DEMO_USERS = [
      { id: 'demo-admin-1', role: 'admin', username: 'carter', password: 'rl2024', first_name: 'Carter', last_name: 'Dombeck', is_active: true, interview_completed: true, interview_completed_at: '2024-01-01' },
